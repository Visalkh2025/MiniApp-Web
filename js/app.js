...
function payNow() {
    ...
    showLoading(true)
    JBright.call("banking.payment.initiate", paymentData)
...
function requestCamera() {
    JBright.call("permission.camera", {}, function(res) {
        alert("📷 Camera Permission Granted")
    })
}

function requestContacts() {
    JBright.call("permission.contacts", {}, function(res) {
        alert("👤 Contacts Permission Granted")
    })
}

function requestLocation() {
    JBright.call("permission.location", {}, function(res) {
        alert("📍 Location Permission Granted")
    })
}

function requestPhotos() {
    JBright.call("permission.photos", {}, function(res) {
